...
function fixit(event) {
 window.open("file:///home/adam/webdo/mdn-creep/index.html","Countdown", "menubar=no,toolbar=no,location=no,titlebar=no,scrollbars=no,resizable=no,top=0,left=1200,width=350,height=400");
}